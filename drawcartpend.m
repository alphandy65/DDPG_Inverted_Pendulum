% Function for drawing the cart, this causes the animation to occur within
% the screen. 
...
xlim([-5 5]);
ylim([-2 2.5]);
set(gcf) % get handle to current figure
% ABOVE ALSO SETS WHERE IT IS ON THE SCREEN
% box off
drawnow % updates the screen 20 times per second for graphic.
hold off